...
/* USER CODE END MX_GPIO_Init_1 */
  ...
  HAL_GPIO_WritePin(GPIOA, DOT_Pin|LR_Pin|EN0_Pin|EN1_Pin
  ...
  /*Configure GPIO pins : DOT_Pin LR_Pin EN0_Pin EN1_Pin
                           EN2_Pin EN3_Pin */
  GPIO_InitStruct.Pin = DOT_Pin|LR_Pin|EN0_Pin|EN1_Pin
                          |EN2_Pin|EN3_Pin;
