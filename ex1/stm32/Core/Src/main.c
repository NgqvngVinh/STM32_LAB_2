...
/* USER CODE END MX_GPIO_Init_1 */
  ...
  HAL_GPIO_WritePin(GPIOA, LR_Pin|EN0_Pin|EN1_Pin|EN2_Pin
  ...
  /*Configure GPIO pins : LR_Pin EN0_Pin EN1_Pin EN2_Pin
                           EN3_Pin */
  GPIO_InitStruct.Pin = LR_Pin|EN0_Pin|EN1_Pin|EN2_Pin
                          |EN3_Pin;
